...
impl RearPort {
    ...
    pub fn new(id: i32, url: String, display: String, device: crate::models::NestedDevice, name: String, r#type: crate::models::FrontPortType, cable: Option<crate::models::NestedCable>, cable_end: String, link_peers: Vec<serde_json::Value>, link_peers_type: String, created: Option<String>, last_updated: Option<String>, _occupied: bool) -> RearPort {
        RearPort {
            id,
            url,
            display,
