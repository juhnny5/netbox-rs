...
pub struct InterfaceRequest {
    ...
    pub untagged_vlan: Option<Option<Box<crate::models::NestedVlanRequest>>>,
...
impl InterfaceRequest {
    ...
    pub fn new(device: crate::models::NestedDeviceRequest, name: String, r#type: Type) -> InterfaceRequest {
        InterfaceRequest {
