...
pub struct FrontPortRequest {
    ...
    pub rear_port: Box<crate::models::FrontPortRearPortRequest>,
...
impl FrontPortRequest {
    /// Adds support for custom fields and tags.
    pub fn new(device: crate::models::NestedDeviceRequest, name: String, r#type: Type, rear_port: crate::models::FrontPortRearPortRequest) -> FrontPortRequest {
        FrontPortRequest {
