...
pub struct FrontPortTemplateRequest {
    ...
    pub rear_port: Box<crate::models::NestedRearPortTemplateRequest>,
...
impl FrontPortTemplateRequest {
    /// Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
    pub fn new(name: String, r#type: Type, rear_port: crate::models::NestedRearPortTemplateRequest) -> FrontPortTemplateRequest {
