...
impl CircuitTermination {
    ...
    pub fn new(id: i32, url: String, display: String, circuit: crate::models::NestedCircuit, term_side: TermSide, cable: Option<crate::models::NestedCable>, cable_end: String, link_peers: Vec<serde_json::Value>, link_peers_type: String, created: Option<String>, last_updated: Option<String>, _occupied: bool) -> CircuitTermination {
        CircuitTermination {
            id,
            url,
            display,
