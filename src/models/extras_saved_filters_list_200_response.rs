...
pub struct ExtrasSavedFiltersList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::SavedFilter>,
}

impl ExtrasSavedFiltersList200Response {
    pub fn new(count: i32, results: Vec<crate::models::SavedFilter>) -> ExtrasSavedFiltersList200Response {
