...
pub struct DeviceTypeRequest {
    ...
    pub default_platform: Option<Option<Box<crate::models::NestedPlatformRequest>>>,
    #[serde(rename = "model")]
    pub model: String,
    #[serde(rename = "slug")]
    pub slug: String,
    ...
    pub subdevice_role: Option<Option<SubdeviceRole>>,
...
impl DeviceTypeRequest {
    /// Adds support for custom fields and tags.
    pub fn new(manufacturer: crate::models::NestedManufacturerRequest, model: String, slug: String) -> DeviceTypeRequest {
        DeviceTypeRequest {
