...
impl RearPortTemplate {
    ...
    pub fn new(id: i32, url: String, display: String, name: String, r#type: crate::models::FrontPortType, created: Option<String>, last_updated: Option<String>) -> RearPortTemplate {
        RearPortTemplate {
            id,
            url,
            display,
