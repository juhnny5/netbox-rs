...
pub struct VmInterfaceRequest {
    ...
    pub virtual_machine: Box<crate::models::NestedVirtualMachineRequest>,
    #[serde(rename = "name")]
    pub name: String,
...
impl VmInterfaceRequest {
    /// Adds support for custom fields and tags.
    pub fn new(virtual_machine: crate::models::NestedVirtualMachineRequest, name: String) -> VmInterfaceRequest {
        VmInterfaceRequest {
