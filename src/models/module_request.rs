...
pub struct ModuleRequest {
    ...
    pub module_type: Box<crate::models::NestedModuleTypeRequest>,
...
impl ModuleRequest {
    ...
    pub fn new(device: crate::models::NestedDeviceRequest, module_bay: crate::models::NestedModuleBayRequest, module_type: crate::models::NestedModuleTypeRequest) -> ModuleRequest {
        ModuleRequest {
