...
pub struct PaginatedVirtualMachineWithConfigContextList {
    ...
    pub results: Option<Vec<crate::models::VirtualMachineWithConfigContext>>,
}

impl PaginatedVirtualMachineWithConfigContextList {
    pub fn new() -> PaginatedVirtualMachineWithConfigContextList {
