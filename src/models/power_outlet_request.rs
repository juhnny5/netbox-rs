...
pub struct PowerOutletRequest {
    ...
    pub power_port: Option<Option<Box<crate::models::NestedPowerPortRequest>>>,
    /// * `A` - A * `B` - B * `C` - C
...
impl PowerOutletRequest {
    /// Adds support for custom fields and tags.
    pub fn new(device: crate::models::NestedDeviceRequest, name: String) -> PowerOutletRequest {
        PowerOutletRequest {
