...
impl DeviceBayTemplate {
    ...
    pub fn new(id: i32, url: String, display: String, device_type: crate::models::NestedDeviceType, name: String, created: Option<String>, last_updated: Option<String>) -> DeviceBayTemplate {
        DeviceBayTemplate {
            id,
            url,
            display,
