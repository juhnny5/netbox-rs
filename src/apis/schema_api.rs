...
pub async fn schema_retrieve(configuration: &configuration::Configuration, format: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<SchemaRetrieveError>> {
