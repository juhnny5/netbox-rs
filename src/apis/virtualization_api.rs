...
pub async fn virtualization_interfaces_list(configuration: &configuration::Configuration, id: Option<&str>, name: Option<&str>, enabled: Option<&str>, mtu: Option<&str>, description: Option<&str>, created: Option<&str>, last_updated: Option<&str>, q: Option<&str>, tag: Option<&str>, cluster_id: Option<&str>, cluster: Option<&str>, virtual_machine_id: Option<&str>, virtual_machine: Option<&str>, parent_id: Option<&str>, bridge_id: Option<&str>, mac_address: Option<&str>, vrf_id: Option<&str>, vrf: Option<&str>, l2vpn_id: Option<&str>, l2vpn: Option<&str>, id__n: Option<&str>, id__lte: Option<&str>, id__lt: Option<&str>, id__gte: Option<&str>, id__gt: Option<&str>, name__n: Option<&str>, name__ic: Option<&str>, name__nic: Option<&str>, name__iew: Option<&str>, name__niew: Option<&str>, name__isw: Option<&str>, name__nisw: Option<&str>, name__ie: Option<&str>, name__nie: Option<&str>, name__empty: Option<&str>, mtu__n: Option<&str>, mtu__lte: Option<&str>, mtu__lt: Option<&str>, mtu__gte: Option<&str>, mtu__gt: Option<&str>, description__n: Option<&str>, description__ic: Option<&str>, description__nic: Option<&str>, description__iew: Option<&str>, description__niew: Option<&str>, description__isw: Option<&str>, description__nisw: Option<&str>, description__ie: Option<&str>, description__nie: Option<&str>, description__empty: Option<&str>, created__n: Option<&str>, created__lte: Option<&str>, created__lt: Option<&str>, created__gte: Option<&str>, created__gt: Option<&str>, last_updated__n: Option<&str>, last_updated__lte: Option<&str>, last_updated__lt: Option<&str>, last_updated__gte: Option<&str>, last_updated__gt: Option<&str>, tag__n: Option<&str>, cluster_id__n: Option<&str>, cluster__n: Option<&str>, virtual_machine_id__n: Option<&str>, virtual_machine__n: Option<&str>, parent_id__n: Option<&str>, bridge_id__n: Option<&str>, mac_address__n: Option<&str>, mac_address__ic: Option<&str>, mac_address__nic: Option<&str>, mac_address__iew: Option<&str>, mac_address__niew: Option<&str>, mac_address__isw: Option<&str>, mac_address__nisw: Option<&str>, mac_address__ie: Option<&str>, mac_address__nie: Option<&str>, vrf_id__n: Option<&str>, vrf__n: Option<&str>, l2vpn_id__n: Option<&str>, l2vpn__n: Option<&str>, ordering: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::VirtualizationInterfacesList200Response, Error<VirtualizationInterfacesListError>> {
    let local_var_configuration = configuration;
...
pub async fn virtualization_virtual_machines_list(configuration: &configuration::Configuration, id: Option<&str>, cluster: Option<&str>, vcpus: Option<&str>, memory: Option<&str>, disk: Option<&str>, created: Option<&str>, last_updated: Option<&str>, q: Option<&str>, tag: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, contact: Option<&str>, contact_role: Option<&str>, contact_group: Option<&str>, local_context_data: Option<&str>, status: Option<&str>, cluster_group_id: Option<&str>, cluster_group: Option<&str>, cluster_type_id: Option<&str>, cluster_type: Option<&str>, cluster_id: Option<&str>, device_id: Option<&str>, device: Option<&str>, region_id: Option<&str>, region: Option<&str>, site_group_id: Option<&str>, site_group: Option<&str>, site_id: Option<&str>, site: Option<&str>, name: Option<&str>, role_id: Option<&str>, role: Option<&str>, platform_id: Option<&str>, platform: Option<&str>, mac_address: Option<&str>, has_primary_ip: Option<&str>, id__n: Option<&str>, id__lte: Option<&str>, id__lt: Option<&str>, id__gte: Option<&str>, id__gt: Option<&str>, cluster__n: Option<&str>, vcpus__n: Option<&str>, vcpus__lte: Option<&str>, vcpus__lt: Option<&str>, vcpus__gte: Option<&str>, vcpus__gt: Option<&str>, memory__n: Option<&str>, memory__lte: Option<&str>, memory__lt: Option<&str>, memory__gte: Option<&str>, memory__gt: Option<&str>, disk__n: Option<&str>, disk__lte: Option<&str>, disk__lt: Option<&str>, disk__gte: Option<&str>, disk__gt: Option<&str>, created__n: Option<&str>, created__lte: Option<&str>, created__lt: Option<&str>, created__gte: Option<&str>, created__gt: Option<&str>, last_updated__n: Option<&str>, last_updated__lte: Option<&str>, last_updated__lt: Option<&str>, last_updated__gte: Option<&str>, last_updated__gt: Option<&str>, tag__n: Option<&str>, tenant_group_id__n: Option<&str>, tenant_group__n: Option<&str>, tenant_id__n: Option<&str>, tenant__n: Option<&str>, contact__n: Option<&str>, contact_role__n: Option<&str>, contact_group__n: Option<&str>, status__n: Option<&str>, cluster_group_id__n: Option<&str>, cluster_group__n: Option<&str>, cluster_type_id__n: Option<&str>, cluster_type__n: Option<&str>, cluster_id__n: Option<&str>, device_id__n: Option<&str>, device__n: Option<&str>, region_id__n: Option<&str>, region__n: Option<&str>, site_group_id__n: Option<&str>, site_group__n: Option<&str>, site_id__n: Option<&str>, site__n: Option<&str>, name__n: Option<&str>, name__ic: Option<&str>, name__nic: Option<&str>, name__iew: Option<&str>, name__niew: Option<&str>, name__isw: Option<&str>, name__nisw: Option<&str>, name__ie: Option<&str>, name__nie: Option<&str>, name__empty: Option<&str>, role_id__n: Option<&str>, role__n: Option<&str>, platform_id__n: Option<&str>, platform__n: Option<&str>, mac_address__n: Option<&str>, mac_address__ic: Option<&str>, mac_address__nic: Option<&str>, mac_address__iew: Option<&str>, mac_address__niew: Option<&str>, mac_address__isw: Option<&str>, mac_address__nisw: Option<&str>, mac_address__ie: Option<&str>, mac_address__nie: Option<&str>, ordering: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::VirtualizationVirtualMachinesList200Response, Error<VirtualizationVirtualMachinesListError>> {
    let local_var_configuration = configuration;
